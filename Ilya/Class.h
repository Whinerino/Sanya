...
CComplexVector0(const size_t &n):CComplexVector(n){};
CComplexVector0(const ComplexNumber *rhs,const int &n){this->n=n;CopyOnly(rhs,n);}
CComplexVector0(const CComplexVector0 &rhs):CComplexVector(rhs){}
CComplexVector0(CComplexVector0 &&rhs){n=rhs.n;v=rhs.v;rhs.SetZero();}
CComplexVector &operator=(const CComplexVector &rhs){if(this!=&rhs){Clean();CopyOnly(rhs);} return *this;}
CComplexVector &operator=(CComplexVector &&rhs){if(this!=&rhs){delete v;n=rhs.n;v=rhs.v;rhs.SetZero();} return *this;}
